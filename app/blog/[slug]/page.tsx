...
export default async function BlogPage(props: {
	...
	const { content, metadata, tableOfContents } = post;

	return (
		<section className="pt-28">
			<div className="container max-w-4xl space-y-8">
				<div className="mb-6 md:hidden text-zinc-800 dark:text-zinc-300">
					<Link
						href="/blog"
				...
				<div className="grid grid-cols-1 md:grid-cols-5 gap-2">
					<div className="hidden md:block md:col-span-1 sticky max-h-[70vh] top-28 overflow-y-auto text-zinc-800 dark:text-zinc-300">
						<div className="mb-6">
							<Link
								href="/blog"
								className="flex gap-2 items-center hover:opacity-70"
